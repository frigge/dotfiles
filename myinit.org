...
#+begin_src emacs-lisp
  (use-package org-pomodoro
    :ensure t
    :bind (:map evil-normal-state-map ("SPC o p" . org-pomodoro)))
#+end_src
...
** capture
#+begin_src emacs-lisp
(define-key evil-normal-state-map (kbd "SPC c c") 'org-capture)
#+end_src
** agenda
#+begin_src emacs-lisp
  (custom-set-variables
...
#+begin_src emacs-lisp
    (use-package org-projectile
      :ensure t
      :bind (:map evil-normal-state-map ("SPC c p" . org-projectile:project-todo-completing-read))
                  :config (progn
