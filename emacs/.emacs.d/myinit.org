...
#+begin_src emacs-lisp
  ...
  ;; define copilot complete key TAB but do not override TAB in insert mode

  (with-eval-after-load 'evil
    (evil-define-key 'insert 'global (kbd "TAB") 'copilot-complete))
#+end_src
...
(defun efs/org-font-setup ()
  ...
  (dolist (face '((org-level-1 . 2.0)
				  ...
				  (org-level-7 . 1.1)
				  (org-level-8 . 1.1)))
	(set-face-attribute (car face) nil :foreground 'unspecified :background 'unspecified :font "Cantarell" :weight 'regular :height (cdr face)))
