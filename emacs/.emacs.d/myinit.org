...
(defun org-projectile-open-todo ()
  "Open TODO.org in folder of current file if it exists, otherwise
open or create a file at the project root"
  (interactive)
  (find-file (walk-up-until-org-todo (projectile-project-root) (file-name-directory buffer-file-name))))
